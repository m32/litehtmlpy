...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tns="http://crd.gov.pl/wzor/2022/08/18/11723/" version="1.0">
			...
			<table class="normalna">
				<tr>
					<td class="wypelniane" style="width:25%" colspan="2">
						...
						<xsl:choose>
							<xsl:when test="tns:P_118_1 = 1">118. <input type="checkbox" checked="checked" disabled="disabled"/>art. 21 ust. 1 pkt 152 ustawy<br/>
							</xsl:when>
							<xsl:otherwise>
						...
						<xsl:choose>
							<xsl:when test="tns:P_119_1 = 1">119. <input type="checkbox" checked="checked" disabled="disabled"/> art. 21 ust. 1 pkt 153 ustawy<br/>
							</xsl:when>
							<xsl:otherwise>
						...
						<xsl:choose>
							<xsl:when test="tns:P_120_1 = 1">120. <input type="checkbox" checked="checked" disabled="disabled"/> art. 21 ust. 1 pkt 154 ustawy<br/>
							</xsl:when>
							<xsl:otherwise>
